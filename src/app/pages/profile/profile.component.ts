...
export class Profile {
    pitems = [
        ...
        {id:'referral-code',label: 'الكود الترويجي',iconclass: 'j-icon-active-two-person',href:'/referral-code'},
        {id:'financial-operations',label: 'العمليات المالية',iconclass: 'j-icon-active-cash',href:'/financial-operations'},
        {id:'technical-support',label: 'الدعم الفني',iconclass: 'j-icon-receiver',href:'/technical-support'},
